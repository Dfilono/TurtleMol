...
def getOptions():
    boxOptions = {
        ...
        'Mesh' : {
            ...
            'type' : 'filePath',
            'default' : '',
            'toolTip' : 'Filepath to a mesh file of type .stl, .obj, or .ply'
        },
        ...
        'meshScale' : {
            ...
            'type' : 'float',
            'default' : 1.0,
            'toolTip' : 'Scale your mesh to be larger or smaller'
        },
        ...
        'density' : {
            ...
            'type' : 'float',
            'default' : 1.0,
            'toolTip' : 'Choose the density of the mesh you want to fill!',
            'suffix' : 'gmol/mL'
        }
    }
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser('Density Mesh')
